<?php
  ...
  if(!isset($_SESSION['inputcart']) || $_SESSION['inputcart'] == null ){
...
<html lang="en">
  ...
  ?>
        <div class="container d-flex justify-content-center mt-5 ">
          <?php
            echo $generator->getBarcode($data[2], $generator::TYPE_CODE_128);
          ?>
        </div>  
  ...
  ?>
    ...
    <script>
      $(document).ready(function(){
        ...
        window.setTimeout(function() {
          location.replace("./status.php?s=inputBarangMasuk");
        }, 3000);
      });
    </script>
